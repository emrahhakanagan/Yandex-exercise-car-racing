...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command == 1) {
                ...
                changePointAndDistance(userCar, distance, points); // передайте в метод аргументы
    ...
    private static void changePointAndDistance(Car userCarNew, int distanceNew, int pointsNew) { // реализуйте метод
        ...
        userCarNew.score += pointsNew;
        userCarNew.kilometersTravelled += distanceNew;
    }
    ...
    private static int generateInt(int from, int to) { // (5, 70)
